...
try {
    ...
    $db->set_charset("utf8"); 
     ...
     $sql4="UPDATE  cuenta SET NumeroTarjeta=".$_GET['NumeroTarjeta']." WHERE id=".$_GET['clienteId'];
     $sql5="UPDATE  cuenta SET pin=".$_GET['pin']." WHERE id=".$_GET['clienteId'];
     $sql6="UPDATE  cuenta SET saldo=".$_GET['saldo']." WHERE id=".$_GET['clienteId'];
     $sql7="UPDATE  cliente SET FechaExpiracion=".$_GET['FechaExpiracion']." WHERE id=".$_GET['clienteId'];
